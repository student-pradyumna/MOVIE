  ...
  return (
    <div className="w-3/4 sm:w-1/2 md:w-[20%] h-full border-r-2 border-zinc-400 p-4 sm:p-6 md:p-10 overflow-y-auto max-h-screen bg-[#18181B]">
      ...
      <nav className='flex flex-col text-zinc-400 text-base sm:text-lg md:text-xl gap-2 sm:gap-3 leading-normal'>
        ...
        <Link to='/trending' className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="mr-2 ri-fire-fill"></i>Trending
        </Link>
        <Link to='/popular' className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="mr-2 ri-bard-fill"></i>Popular
        </Link>
        <Link to='/movie' className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="ri-movie-2-ai-fill"></i>Movies
        </Link>
        <Link to='/tv' className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="mr-2 ri-tv-2-fill"></i>TV shows
        </Link>
        <Link to='/person' className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="mrr-2 ri-team-fill"></i>People
        </Link>
      </nav>
      ...
      <nav className='flex flex-col text-zinc-400 text-base sm:text-lg md:text-xl gap-2 sm:gap-3 leading-normal'>
        ...
        <Link to="/about" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
          <i className="mr-2 ri-information-2-line"></i>About Movie
        </Link>
        <Link to="/contact" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3 sm:p-4 md:p-5">
