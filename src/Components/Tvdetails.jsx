      ...
      <div className="w-full flex">
        ...
        <h1 className='text-2xl mt-5 mb-3 '>TV Translated</h1>
         <p className='mb-10'>{info.translations.join(', ')}</p>
           ...
           <Link className=' p-5 bg-[#6556CD] rounded-lg' to="trailer"><i className=" text-xl ri-play-fill mr-3"></i>
           Play Trailer</Link>
 ...
 {info.watchproviders && info.watchproviders.rent && (
  ...
  {info.detail.seasons.map((s, i) => (
    <div className='w-[15vh] mr-[8%] '>  
      <img
        className=" h-[36vh] object-cover rounded-md shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[13vw]"
      ...
      <h1 className="text-lg text-zinc-300 mt-2 font-semibold line-clamp-1">
        ...
        <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500' />
<h1 className='text-3xl font-bold text-white mb-5'>Recommendations & Similar Stuff</h1>
